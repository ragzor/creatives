            ...
            <div className="grid gap-4">
              <div className="flex items-start gap-4">
                ...
                <div className="space-y-1">
                  <h3 className="font-medium">Save 80% on Design Costs</h3>
              ...
              <div className="flex items-start gap-4">
                <CheckCircle2 className="mt-1 h-5 w-5 text-primary" />
                <div className="space-y-1">
                  <h3 className="font-medium">Generate Ads 10x Faster</h3>
                  <p className="text-sm text-muted-foreground">
              ...
              <div className="flex items-start gap-4">
                <CheckCircle2 className="mt-1 h-5 w-5 text-primary" />
                <div className="space-y-1">
                  <h3 className="font-medium">Increase Conversion Rates</h3>
                  <p className="text-sm text-muted-foreground">
              ...
              <div className="flex items-start gap-4">
                <CheckCircle2 className="mt-1 h-5 w-5 text-primary" />
                <div className="space-y-1">
                  <h3 className="font-medium">Scale Your Ad Campaigns</h3>
                  <p className="text-sm text-muted-foreground">
